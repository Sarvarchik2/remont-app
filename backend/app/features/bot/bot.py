...
MESSAGES = {
    ...
    "uz": {
        ...
        "thanks": "✅ <b>Rahmat!</b>\n\nProfilingiz sozlandi. Endi Ulaskins-ning barcha funksiyalaridan foydalanishingiz mumkin.",
        "btn_open": "🚀 Ulaskins-ni ochish",
    }
}
...
async def process_language(callback: types.CallbackQuery):
    ...
    if not user.phone:
        ...
        builder.row(KeyboardButton(
            text=MESSAGES[lang]["btn_open"], 
            web_app=WebAppInfo(url=settings.WEB_APP_URL)
        ))
        await callback.message.answer(MESSAGES[lang]["thanks"], reply_markup=builder.as_markup(resize_keyboard=True), parse_mode="HTML")
...
async def handle_contact(message: types.Message):
    ...
    await message.answer(MESSAGES[lang]["thanks"], reply_markup=builder.as_markup(resize_keyboard=True), parse_mode="HTML")
