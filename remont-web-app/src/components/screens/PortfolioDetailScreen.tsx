    ...
    <div className="pb-32 bg-[#F9F9F7] min-h-screen animate-fade-in">
      ...
      <div className="relative w-full aspect-[4/5] lg:aspect-video rounded-b-[40px] overflow-hidden shadow-2xl shadow-slate-200">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
          ...
          <h1 className="text-3xl font-extrabold mb-2 leading-tight">{project.title}</h1>
        ...
        <div className="flex space-x-2 overflow-x-auto pb-2 scrollbar-hide">
          {galleryImages.map((img, idx) => (
            <button
              ...
              className={`relative w-16 h-16 flex-shrink-0 rounded-2xl overflow-hidden border-2 transition-all ${
                activeImage === img ? 'border-[#FFB800] shadow-lg scale-105' : 'border-white opacity-70'
              }`}
            >
